 ...
 */
final class Version20250502190607 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE actions_autorisation (id INT AUTO_INCREMENT NOT NULL, autorisation_id INT NOT NULL, libelle_id INT NOT NULL, checked TINYINT(1) DEFAULT NULL, INDEX IDX_8F9CE87452C5E836 (autorisation_id), INDEX IDX_8F9CE87425DD318D (libelle_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE actions_autorisation ADD CONSTRAINT FK_8F9CE87425DD318D FOREIGN KEY (libelle_id) REFERENCES actions (id)
        SQL);
        $this->addSql(<<<'SQL'
